...
from diaries.models import Diary, Category
from diaries.forms import DiarySearchForm
...
@register.inclusion_tag('diaries/includes/month_links.html')
...
@register.inclusion_tag('diaries/includes/category_links.html')
...
@register.inclusion_tag('diaries/includes/search_form.html')
